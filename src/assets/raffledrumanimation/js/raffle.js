(function($) {
	var pluginName='raffleDrumAnimation',
		init_arr=[],
		defaults={
			itemImage:['raffledrumanimation/assets/ticket1.svg',
							'raffledrumanimation/assets/ticket2.svg',
							'raffledrumanimation/assets/ticket3.svg',
							'raffledrumanimation/assets/ticket4.svg',
							'raffledrumanimation/assets/ticket5.svg'],
			loop:false,
			spinning:false,
			drumSpeed:0,
